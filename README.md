[Sangria](http://sangria-graphql.org/) [spray-json](https://github.com/spray/spray-json) marshalling.
...
```scala
libraryDependencies += "org.sangria-graphql" %% "sangria-spray-json" % "0.2.0"
```
